"""
Venera 13 — Time Masking Analysis
...
fig.suptitle("Venera 13 — Time Masking Analysis",
...
plt.savefig("venera13_time_masking.png", dpi=130,
            bbox_inches="tight", facecolor=BG)
plt.close()
print("\n✅ Saved → venera13_time_masking.png")