"""
Venera 14 Sound Recording - Audio Analysis
Dependencies: numpy, scipy, matplotlib (no librosa needed)
Run: python time_msk_14.py
"""
...
fig.suptitle("Venera 14 — Audio Analysis (first 30 s)",
...
plt.savefig("venera14_analysis.png", dpi=130, bbox_inches="tight", facecolor="#0d0d0d")
plt.close()
print("\n✅ Saved → venera14_analysis.png")